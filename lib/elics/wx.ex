defmodule Elics.WX do
  @moduledoc """
  Elixir version of the constants found in the wx.hrl file, reduced to what is needed in this sample only.
  Sourced from: https://github.com/elixir-desktop/desktop/blob/main/lib/desktop/wx.ex
  """
  @constants ~w(
    ID_ANY ID_EXIT DEFAULT DEFAULT_FRAME_STYLE NO_BORDER EXPAND HORIZONTAL VERTICAL TE_MULTILINE
